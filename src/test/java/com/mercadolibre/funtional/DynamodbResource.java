...
public class DynamodbResource implements QuarkusTestResourceLifecycleManager {
    ...
    public final static String TABLE_NAME = "DnaSequenceInfo";
        ...
        try {
            ...
            client.createTable(tableRequest ->
                tableRequest.tableName(TABLE_NAME)
                    .keySchema(keySchema -> keySchema.attributeName("id").keyType(KeyType.HASH))
                    .attributeDefinitions(attrDef -> attrDef.attributeName("id").attributeType(ScalarAttributeType.S))
